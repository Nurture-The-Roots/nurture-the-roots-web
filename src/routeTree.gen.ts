...
import { Route as VelaRouteImport } from './routes/vela'
...
const VelaRoute = VelaRouteImport.update({
  id: '/vela',
  path: '/vela',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    '/vela': {
      ...
      path: '/vela'
      fullPath: '/vela'
      preLoaderRoute: typeof VelaRouteImport
