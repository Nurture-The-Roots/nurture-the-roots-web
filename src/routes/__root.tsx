...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Nurture The Roots™ offers grounded, identity‑rooted postpartum support from a Fourth Trimester Expert. Serving families in San Francisco with clarity, care, and attuned newborn guidance." },
